...
let EstudianteService = class EstudianteService {
    ...
    async crearEstudiante(estudiante) {
        if (estudiante.codigo_estudiante.length !== 10) {
            throw new common_1.BadRequestException('El código del estudiante debe tener 10 caracteres');
        }
...
exports.EstudianteService = EstudianteService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(estudiante_entity_1.EstudianteEntity)),
